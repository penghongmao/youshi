...
@interface SFBMUIWebViewVC ()<UIWebViewDelegate>
...
@implementation SFBMUIWebViewVC
...
//    NSURLRequest *request = [NSURLRequest requestWithURL:url cachePolicy:NSURLRequestReloadIgnoringLocalCacheData timeoutInterval:130];
