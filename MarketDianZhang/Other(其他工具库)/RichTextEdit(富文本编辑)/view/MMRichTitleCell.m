...
//        // Content
        ...
        CGFloat framesizewidth = [UIScreen mainScreen].bounds.size.width;
        CGRect frame = _textView.frame;
        CGSize constraintSize = CGSizeMake(framesizewidth, MAXFLOAT);
        CGSize size = [_textView sizeThatFits:constraintSize];

        // 更新模型数据
        _titleModel.titleViewFrame = CGRectMake(frame.origin.x, frame.origin.y, framesizewidth, size.height);
        _titleModel.textContent = _textView.text;
        _titleModel.selectedRange = _textView.selectedRange;
