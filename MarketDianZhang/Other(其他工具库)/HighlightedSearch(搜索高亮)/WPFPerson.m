...
+ (instancetype)personWithId:(NSString *)personId name:(NSString *)name company:(NSString *)company headImageData:(NSData *)imageData hanyuPinyinOutputFormat:(HanyuPinyinOutputFormat *)pinyinFormat {
