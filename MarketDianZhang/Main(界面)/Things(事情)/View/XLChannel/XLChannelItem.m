...
-(void)initUI
{
    ...
    _deleteBtn.frame = CGRectMake(-12, -12, 40, 40);
    [_deleteBtn setImage:[UIImage imageNamed:@"delete1"] forState:UIControlStateNormal];
...
-(void)setIsFixed:(BOOL)isFixed{
    _isFixed = isFixed;
    if (isFixed) {
//        _textLabel.textColor = [self lightTextColor];//已废弃
    }else{
        _textLabel.textColor = [self textColor];
    }
}
